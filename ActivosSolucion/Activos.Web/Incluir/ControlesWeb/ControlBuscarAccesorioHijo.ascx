<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlBuscarAccesorioHijo.ascx.cs" Inherits="Activos.Web.Incluir.ControlesWeb.ControlBuscarAccesorioHijo" %>
   ...
   <ContentTemplate>
      ...
      <asp:Panel CssClass="PopupGrandeDiv" ID="pnlControlBuscarAccesorio" runat="server" Visible="False">
         <div class="PopupGrandeEncabezadoDiv">
            <asp:Label class="TitleDivPage" ID="lblTitleBuscarAccesorio" runat="server" Text="Activo padre y sus accesorios Asignados"></asp:Label>

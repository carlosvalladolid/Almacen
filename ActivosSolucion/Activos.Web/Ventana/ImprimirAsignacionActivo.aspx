<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaImpresion.Master" AutoEventWireup="true" CodeBehind="ImprimirAsignacionActivo.aspx.cs" Inherits="Activos.Web.Ventana.ImprimirAsignacionActivo" %>
         ...
         <div ID="DivTabla">
             <asp:GridView ID="TablaActivos" runat="server" AllowPaging="false" 
                 ...
                 <Columns>
                     ...
                     <asp:BoundField DataField="NombreCondicion" HeaderText="CONDICIÓN" ItemStyle-HorizontalAlign="Left">
                        <HeaderStyle HorizontalAlign="Left" Width="80px" />
                     </asp:BoundField>
                 </Columns>
             </asp:GridView>

<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaPrivada.Master" AutoEventWireup="true" CodeBehind="Direccion.aspx.cs" Inherits="Activos.Web.Aplicacion.Catalogo.Direccion" %>
...
<asp:Content ID="ContenidoCuerpo" ContentPlaceHolderID="ContenedorCuerpo" runat="server">
    ...
    <div class="DivContenido">
        <div class="DivContenidoTitulo">
            <div class="DivTitulo">Catálogo de direcciones</div>
        </div>

        <div class="DivInformacionContenido">
            <asp:UpdatePanel ID="ActualizarTablaDireccion" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Panel ID="PanelTablaDireccion" runat="server">
                        ...
                        <asp:Panel CssClass="DivBusquedaAvanzada" ID="PanelBusquedaAvanzada" Visible="false" runat="server">
                           <table class="TablaFormulario">
                                <tr>
                                    ...
                                    <td class="Espacio"></td>
                                    <td class="Campo"><asp:TextBox CssClass="CajaTextoGrande" ID="NombreBusqueda" MaxLength="120" runat="server" Text=""></asp:TextBox></td>
                                </tr>
                                <tr>
                                      <td colspan="3">
                                        <br />
                        ...
                        <asp:Panel CssClass="DivNuevoRegistro" id="PanelNuevoRegistro" Visible="false" runat="server">
                            <table class="TablaFormulario">
                                <tr>
                                    ...
                                    <td class="Campo"><asp:DropDownList CssClass="ComboGrande" ID="DependenciaNuevo" MaxLength="20" runat="server" ></asp:DropDownList></td>
                                    <td class="EspacioColumna"></td>
                                </tr>
                                <tr>
                                    <td class="Nombre">Estatus</td>
                                    <td class="Requerido">*</td>
                                    <td class="Campo"><asp:DropDownList CssClass="ComboMediano" ID="EstatusNuevo" MaxLength="20" runat="server" ></asp:DropDownList></td>
                                    
                                </tr>
                                <tr>
                                    <td class="Nombre">Nombre</td>
                                    <td class="Requerido">*</td>
                                    <td class="Campo"><asp:TextBox CssClass="CajaTextoGrande" ID="NombreNuevo" MaxLength="120" runat="server" Text=""></asp:TextBox></td>
                                    <td class="EspacioColumna"></td>
                                    <td class="Nombre"></td>
                                    <td class="Requerido"></td>
                                    <td class="Campo"></td>
                       ...
                       <asp:Label CssClass="TextoError" ID="EtiquetaMensaje" runat="server" Text=""></asp:Label>
                        ...
                        <div class="DivTabla">
                            <asp:GridView AllowPaging="true" AllowSorting="false" AutoGenerateColumns="false" BorderWidth="0"
                                CssClass="TablaInformacion" DataKeyNames="DireccionId" ID="TablaDireccion"
                                 OnPageIndexChanging="TablaDireccion_PageIndexChanging" OnRowCommand="TablaDireccion_RowCommand" runat="server" PageSize="10">
                                <EmptyDataTemplate>
                    ...
                    <asp:UpdateProgress AssociatedUpdatePanelID="ActualizarTablaDireccion" ID="ProgresoTablaDireccion" runat="server">
                        <ProgressTemplate>
                            <div class="DivCargando"><div class="DivCargandoImagen"><img alt="Cargando..." src="/Imagen/Icono/IconoCargando.gif" /></div></div>
                        </ProgressTemplate>
                    </asp:UpdateProgress>
                    <asp:HiddenField ID="DireccionIdHidden" runat="server" Value="0" />
                </ContentTemplate>

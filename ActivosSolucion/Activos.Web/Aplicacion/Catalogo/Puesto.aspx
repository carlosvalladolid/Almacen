<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaPrivada.Master" AutoEventWireup="true" CodeBehind="Puesto.aspx.cs" Inherits="Activos.Web.Aplicacion.Catalogo.Puesto" %>
...
<asp:Content ID="ContenidoCuerpo" ContentPlaceHolderID="ContenedorCuerpo" runat="server">
    ...
    <div class="DivContenido">
        <div class="DivContenidoTitulo">
            <div class="DivTitulo">Catálogo de puesto</div>
        </div>

    <div class="DivInformacionContenido">
            <asp:UpdatePanel ID="ActualizarTablaPuesto" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Panel ID="PanelTablaPuesto" runat="server">
                       ...
                       <asp:Label CssClass="TextoError" ID="EtiquetaMensaje" runat="server" Text=""></asp:Label>
                        ...
                        <div class="DivTabla">
                            <asp:GridView AllowPaging="true" AllowSorting="false" AutoGenerateColumns="false" BorderWidth="0"
                                CssClass="TablaInformacion" DataKeyNames="PuestoId" ID="TablaPuesto"
                                 OnPageIndexChanging="TablaPuesto_PageIndexChanging" OnRowCommand="TablaPuesto_RowCommand" runat="server" PageSize="10">
                                <EmptyDataTemplate>
                                    <table class="TablaVacia">
                                        <tr class="Encabezado">
                                             <th style="width: 30px;"></th>
                                            <th>Nombre</th>
                                            <th style="width: 300px;">Dependencia</th>
                    ...
                    <asp:UpdateProgress AssociatedUpdatePanelID="ActualizarTablaPuesto" ID="ProgresoTablaPuesto" runat="server">
                        <ProgressTemplate>

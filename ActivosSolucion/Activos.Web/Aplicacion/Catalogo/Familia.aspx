<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaPrivada.Master" AutoEventWireup="true" CodeBehind="Familia.aspx.cs" Inherits="Activos.Web.Aplicacion.Catalogo.Familia" %>
...
<asp:Content ID="ContenidoCuerpo" ContentPlaceHolderID="ContenedorCuerpo" runat="server">
    ...
    <div class="DivContenido">
        <div class="DivContenidoTitulo">
            <div class="DivTitulo">Catálogo de familias</div>
        </div>

        <div class="DivInformacionContenido">
            <asp:UpdatePanel ID="ActualizarTablaFamilia" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Panel ID="PanelTablaFamilia" runat="server">
                        ...
                        <div class="DivTabla">
                            <asp:GridView AllowPaging="true" AllowSorting="false" AutoGenerateColumns="false" BorderWidth="0"
                                CssClass="TablaInformacion" DataKeyNames="FamiliaId" ID="TablaFamilia"
                                 OnPageIndexChanging="TablaFamilia_PageIndexChanging" OnRowCommand="TablaFamiliaRowCommand" runat="server" PageSize="10">
                                <EmptyDataTemplate>
                    ...
                    <asp:UpdateProgress AssociatedUpdatePanelID="ActualizarTablaFamilia" ID="ProgresoTablaFamilia" runat="server">
                        <ProgressTemplate>

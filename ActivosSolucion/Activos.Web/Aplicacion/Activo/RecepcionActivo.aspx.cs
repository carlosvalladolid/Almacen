...
{
    public partial class RecepcionActivo : System.Web.UI.Page
    {
        #region "Eventos"
        ...
        #region "Métodos"
                    ...
                    if (decimal.Parse(MontoDocumento.Text.Trim()) == decimal.Parse(MontoTotalHidden.Value))
                    {
                        if (TablaActivo.Rows.Count > 0)
                        {
                            ...
                            if (SolicitanteIdHidden.Value != "0")
                            {
                                ...
                                GuardarRecepcion(CompraObjetoEntidad, (Int16)ConstantePrograma.TipoMovimiento.Alta);
                            }
                        }
                        else
                        {
            ...
            protected void Inicio()
            {
                if (!Page.IsPostBack)
                {
                    ...
                    BaseProcesoNegocio.ValidarPermiso((Int16)ConstantePrograma.Paginas.RecepcionActivos);

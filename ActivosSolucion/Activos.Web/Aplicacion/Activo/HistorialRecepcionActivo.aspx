<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaPrivada.Master" AutoEventWireup="true" CodeBehind="HistorialRecepcionActivo.aspx.cs" Inherits="Activos.Web.Aplicacion.Activo.HistorialRecepcionActivo" %>
...
<asp:Content ID="ContenidoCuerpo" ContentPlaceHolderID="ContenedorCuerpo" runat="server">
    ...
    <div class="DivContenido">
        <div class="DivContenidoTitulo">
            <div class="DivTitulo">Historial de activo</div>
        </div>
                     ...
                     <asp:Panel CssClass="DivCampo" id="PanelDatoGeneral" runat="server">
                        <table class="TablaFormulario">
                          <tr>
                              ...
                              <td class="Espacio">&nbsp;</td>
                              <td class="Campo"><asp:DropDownList CssClass="ComboXL" ID="ProveedorId" runat="server" ></asp:DropDownList></td>
                          ...
                          <tr>
                              ...
                              <td class="Espacio">&nbsp;</td>
                              <td class="Campo">
                                 <asp:TextBox CssClass="CajaTextoGrande" ID="NombreJefe" Enabled="false" MaxLength="150" runat="server" Text=""></asp:TextBox>&nbsp;
                                 <asp:ImageButton ImageUrl="/Imagen/Icono/ImagenBuscar.gif" ID="BotonBuscarJefe" OnClick="BotonBuscarJefe_Click" runat="server" />
                              </td>
                              <td class="EspacioColumna"></td>
                          </tr>
                        </table> 
                     ...
                     <asp:Panel CssClass="DivCampo" id="PanelDocumentoDetalle" runat="server">
                        <div class="DivCampoIzquierda">
                           <table class="TablaFormulario">
                                <tr>
                                    ...
                                    <td class="Campo">
                                       <asp:Panel ID="Panel1" runat="server" DefaultButton="LinkBuscarEmpleado">
                                          <asp:TextBox ID="NumeroEmpleado" OnTextChanged="NumeroEmpleado_TextChanged" AutoPostBack="true" CssClass="CajaTextoMediana" MaxLength="10" runat="server"></asp:TextBox>&nbsp;
                                ...
                                <tr>
                                    <td class="Nombre">Cód. Bar. Particular</td>
                                    <td class="Espacio">&nbsp;</td>
                                    <td class="Campo"><asp:TextBox CssClass="CajaTextoMediana" ID="ActivoCodigoBarrasParticular" MaxLength="15" runat="server" Text=""></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="Nombre">Cód. Bar. General</td>
                                    <td class="Espacio">&nbsp;</td>
                                    <td class="Campo"><asp:TextBox CssClass="CajaTextoMediana" ID="ActivoCodigoBarrasGeneral" MaxLength="15" runat="server" Text=""></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="Nombre"></td>
                                    <td class="Espacio">&nbsp;</td>
                                    <td class="Campo"><asp:CheckBox ID="UbicacionActivoBodega" Checked="false" runat="server" Text=" Bodega" /></td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                       <asp:RequiredFieldValidator CssClass="TextoError" ControlToValidate="NumeroEmpleado" Display="Dynamic" ErrorMessage="" ID="NumeroEmpleadoRequerido" SetFocusOnError="true" ValidationGroup="AgregarActivo" runat="server"></asp:RequiredFieldValidator>
                                       ...
                                       <asp:RequiredFieldValidator CssClass="TextoError" ControlToValidate="ActivoCodigoBarrasParticular" Display="Dynamic" ErrorMessage="" ID="ActivoCodigoBarrasParticularRequerido" SetFocusOnError="true" ValidationGroup="AgregarActivo" runat="server"></asp:RequiredFieldValidator>
                        ...
                        <br />
                        <asp:Panel CssClass="PopupAltoDiv" ID="pnlAccesorio" Visible="false" runat="server">
                           <div class="PopupAltoEncabezadoDiv">
                              <asp:Label class="TitleDivPage" ID="lblTitleAccesorio" runat="server" Text="Accesorios"></asp:Label>
                           </div> 
                           <div class="PopupAltoCuerpoDiv">

<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaPrivada.Master" AutoEventWireup="true" CodeBehind="ReporteGeneralMantenimientos.aspx.cs" Inherits="Activos.Web.Aplicacion.Reportes.ReporteGeneralMantenimientos" ViewStateEncryptionMode="Never"%>
   ...
   <script language="javascript" type="text/javascript">
       function pageLoad(sender, args) {
        ...
        function Imprimir() {
           ...
           Form.action = "/Ventana/ImprimirReporteGeneralMantenimientos.aspx";
           Form.target = "_blank";
           Form.submit();

           Form.action = "ReporteGeneralMantenimientos.aspx";
           Form.target = "_self";
        }
...
<asp:Content ID="ContenidoCuerpo" ContentPlaceHolderID="ContenedorCuerpo" runat="server">
   ...
   <div class="DivContenido">
      <div class="DivContenidoTitulo">
           <div class="DivTitulo">Reporte general de mantenimientos</div>
      </div>
                     ...
                     <table class="TablaFormulario">
                        ...
                        <tr>
                           <td colspan="3">
                              ...
                              <br />
                              <asp:ImageButton ID="BotonImprimir" runat="server" AlternateText="Imprimir"
                                  ImageUrl="/Imagen/Boton/BotonImprimir.png" OnClick="BotonImprimir_Click" ValidationGroup="Imprimir"/>&nbsp;&nbsp;

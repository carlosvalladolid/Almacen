<%@ Page Title="" Language="C#" MasterPageFile="~/Incluir/Plantilla/PlantillaPrivada.Master" AutoEventWireup="true" CodeBehind="ReporteRastreoAccesorio.aspx.cs" Inherits="Activos.Web.Aplicacion.Reportes.ReporteRastreoAccesorio" ViewStateEncryptionMode="Never" %>
...
<asp:Content ID="ContenidoEncabezado" ContentPlaceHolderID="ContenedorEncabezado" runat="server">
   <script language="javascript" type="text/javascript">
        ...
        function Imprimir() {
           ...
           Form.action = "/Ventana/ImprimirReporteRastreoAccesorio.aspx";
           Form.target = "_blank";
           Form.submit();

           Form.action = "ReporteRastreoAccesorio.aspx";
           Form.target = "_self";
        }
...
<asp:Content ID="ContenidoCuerpo" ContentPlaceHolderID="ContenedorCuerpo" runat="server">
   ...
   <div class="DivContenido">
      <div class="DivContenidoTitulo">
           <div class="DivTitulo">Reporte rastreo de accesorios</div>
      </div>
                      ...
                      <asp:GridView AllowPaging="true" AllowSorting="false" AutoGenerateColumns="false" BorderWidth="0"
                          ...
                          <EmptyDataTemplate>
                              <table class="TablaVacia">
                                  ...
                                  <tr>
                                      <td colspan="3" style="text-align: center;">No se encontraron movimientos con los parametros seleccionados</td>
                                  </tr>
                              </table>
                          </EmptyDataTemplate>

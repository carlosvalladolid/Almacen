   ...
   public class SubFamiliaPuestoAcceso:Base
    {
       ...
       public ResultadoEntidad SeleccionarSubFamiliaPuestoEditar(SubFamiliaPuestoEntidad SubFamiliaPuestoEntidadObjeto, string CadenaConexion)
       {
           DataSet ResultadoDatos = new DataSet();
           SqlConnection Conexion = new SqlConnection(CadenaConexion);
           SqlCommand Comando;
           ...
           try
           {
               Comando = new SqlCommand("SeleccionaSubFamiliaPuestoProcedimiento", Conexion);
               Comando.CommandType = CommandType.StoredProcedure;

...
{
    public partial class ControlBuscarAccesorioHijo : System.Web.UI.UserControl

    {
        ...
        {
            this.Page.GetType().InvokeMember("UsarActivoPadre", System.Reflection.BindingFlags.InvokeMethod, null, this.Page, new object[] { });
        }

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlBuscarAccesorios.ascx.cs" Inherits="Activos.Web.Incluir.ControlesWeb.ControlBuscarAccesorios" %>
      ...
      <asp:Panel CssClass="PopupGrandeDiv" ID="pnlControlBuscarAccesorio" runat="server" Visible="False">
         ...
         <div class="PopupGrandeCuerpoDiv">
          ...
          <div class="PopupGrandePieDiv">
           <asp:Label Font-Bold="true" CssClass="TextoError" ID="AceptarMensajeDarBaja" runat="server" Text="" ></asp:Label><br />
        &nbsp;&nbsp;

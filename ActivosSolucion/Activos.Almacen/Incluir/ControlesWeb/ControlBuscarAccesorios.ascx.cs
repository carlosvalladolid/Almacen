...
{
    public partial class ControlBuscarAccesorios : System.Web.UI.UserControl
    {
        #region Eventos
        ...
        protected void LlenarControl(AccesorioEntidad AccesorioObjetoEntidad)
        {
            ...
            AceptarMensajeDarBaja.Text = "Este activo cuenta con accesorios asignados, \n ¿Desea dar de baja el activo junto con sus accesorios?";
